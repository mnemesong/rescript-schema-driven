...
var TestOptionInt = require("./TestOptionInt.bs.js");
...
var struct = S$RescriptStruct.$$Object.strip(S$RescriptStruct.object(function (o) {
          return {
                  id: S$RescriptStruct.field(o, "id", SchemaDrivenInt.struct),
                  ages: S$RescriptStruct.field(o, "ages", TestOptionInt.struct),
                  name: S$RescriptStruct.field(o, "name", SchemaDrivenString.struct)
                };
        }));
