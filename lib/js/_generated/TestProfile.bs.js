...
var TestPerson = require("./TestPerson.bs.js");
...
var struct = S$RescriptStruct.$$Object.strip(S$RescriptStruct.object(function (o) {
          return {
                  person: S$RescriptStruct.field(o, "person", TestPerson.struct),
                  descr: S$RescriptStruct.field(o, "descr", TestOptionStr.struct)
                };
        }));
