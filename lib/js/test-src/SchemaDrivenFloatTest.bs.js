...
Mocha$RescriptMocha.describe("SchemaDrivenFloatTest")(undefined, undefined, undefined, (function (param) {
        Mocha$RescriptMocha.it("test assertion")(undefined, undefined, undefined, (function (param) {
                var result = S$RescriptStruct.parseWith(0.5, SchemaDrivenFloat.struct);
        ...
        Mocha$RescriptMocha.it("test invalid")(undefined, undefined, undefined, (function (param) {
                var result = S$RescriptStruct.parseWith(false, SchemaDrivenFloat.struct);
        ...
        Mocha$RescriptMocha.it("test serialization")(undefined, undefined, undefined, (function (param) {
                var result = Belt_Result.flatMap(S$RescriptStruct.serializeToJsonWith(-5.001, undefined, SchemaDrivenFloat.struct), (function (s) {
                        return S$RescriptStruct.parseJsonWith(s, SchemaDrivenFloat.struct);
                      }));
                Assert$RescriptMocha.deep_equal(undefined, result, {
                      TAG: /* Ok */0,
                      _0: -5.001
