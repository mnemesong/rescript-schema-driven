...
function optionNull(moduleName, t, engine) {
  return SchemaDrivenEngine.printModule(engine, SchemaDrivenOptionNull.makeResultCode(moduleName, t));
}

function record(strictOpt, moduleName, props, engine) {
  var strict = strictOpt !== undefined ? strictOpt : false;
  return SchemaDrivenEngine.printModule(engine, SchemaDrivenRecord.makeResultCode(moduleName, props, strict));
}

function object(strictOpt, moduleName, props, engine) {
  var strict = strictOpt !== undefined ? strictOpt : false;
  return SchemaDrivenEngine.printModule(engine, SchemaDrivenObject.makeResultCode(moduleName, props, strict));
}

function tupleN(moduleName, params, engine) {
  return SchemaDrivenEngine.printModule(engine, SchemaDrivenTupleN.makeResultCode(moduleName, params));
}

function tupleObject(strictOpt, moduleName, types, engine) {
  var strict = strictOpt !== undefined ? strictOpt : false;
  return SchemaDrivenEngine.printModule(engine, SchemaDrivenTupleObject.makeResultCode(moduleName, types, strict));
}

function variantObject(tagNameOpt, strictOpt, moduleName, variants, engine) {
  var tagName = tagNameOpt !== undefined ? tagNameOpt : "TAG";
  var strict = strictOpt !== undefined ? strictOpt : false;
  return SchemaDrivenEngine.printModule(engine, SchemaDrivenVariantObject.makeResultCode(moduleName, variants, tagName, strict));
}

function variantContainer(tagNameOpt, strictOpt, moduleName, variants, engine) {
  var tagName = tagNameOpt !== undefined ? tagNameOpt : "TAG";
  var strict = strictOpt !== undefined ? strictOpt : false;
  return SchemaDrivenEngine.printModule(engine, SchemaDrivenVariantContainer.makeResultCode(moduleName, variants, tagName, strict));
}

function variantLiteral(moduleName, variants, engine) {
  return SchemaDrivenEngine.printModule(engine, SchemaDrivenVariantLiteral.makeResultCode(moduleName, variants));
}

function array(moduleName, t, engine) {
  return SchemaDrivenEngine.printModule(engine, SchemaDrivenArray.makeResultCode(moduleName, t));
}

function list(moduleName, t, engine) {
  return SchemaDrivenEngine.printModule(engine, SchemaDrivenList.makeResultCode(moduleName, t));
}

function dict(moduleName, t, engine) {
  return SchemaDrivenEngine.printModule(engine, SchemaDrivenDict.makeResultCode(moduleName, t));
}
