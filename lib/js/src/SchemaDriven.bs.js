...
function variantObject(tagNameOpt, moduleName, variants, engine) {
  var tagName = tagNameOpt !== undefined ? tagNameOpt : "TAG";
  return SchemaDrivenEngine.printModule(engine, moduleName, SchemaDrivenVariantObject.makeResultCode(moduleName, variants, tagName));
}

function variantContainer(tagNameOpt, moduleName, variants, engine) {
  var tagName = tagNameOpt !== undefined ? tagNameOpt : "TAG";
  return SchemaDrivenEngine.printModule(engine, moduleName, SchemaDrivenVariantContainer.makeResultCode(moduleName, variants, tagName));
}
